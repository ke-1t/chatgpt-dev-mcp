...
class RuntimeReadback:
    ...
    # The official production host may expose these optional process and
    # endpoint observations to an external operator.  They are deliberately
    # additive so embedders that only implement the core activation contract
    # remain compatible.
    healthz: str = ""
    readyz: str = ""
